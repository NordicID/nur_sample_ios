 ...
 * @sa NurApiUntraceable, NurApiUntraceable32, NurApiUntraceableByEPC
 ...
 */
NUR_API
int NURAPICONV NurApiConnectAppleBLE(HANDLE hApi, void * wrapperReadDataFunction, void * wrapperWriteDataFunction);
...
/** @fn int NURAPICONV NurApiUntraceable(HANDLE hApi, DWORD passwd, struct NUR_UNTRACEABLE_PARAM *pUtrace, DWORD szParam)
 *
 * Performs the Gen2 version 2 "Untraceable" command without explicitly selecting a tag.
 *
 * @sa NurApiUntraceableByEPC, NurApiUntraceable32, NUR_UNTRACEABLE_PARAM
 * @sa NUR_UTRACE_RANGE_NORMAL, NUR_UTRACE_RANGE_REDUCE
 * 	   
 * @param	hApi			Handle to valid NurApi object instance. 
 ...
 */
NUR_API
int NURAPICONV NurApiUntraceable(HANDLE hApi, DWORD passwd, struct NUR_UNTRACEABLE_PARAM *pUtrace, DWORD szParam);

/** @fn int NURAPICONV NurApiUntraceableByEPC(HANDLE hApi, DWORD passwd, BYTE *epcBuffer, DWORD epcBufferLen, struct NUR_UNTRACEABLE_PARAM *pUtrace, DWORD szParam)
 *
 * Performs the Gen2 version 2 "Untraceable" command using the tag's EPC as selection parameter.
 *
 * @sa NurApiUntraceable, NurApiUntraceable32, NUR_UNTRACEABLE_PARAM
 * @sa NUR_UTRACE_RANGE_NORMAL, NUR_UTRACE_RANGE_REDUCE
 * 	   
 * @param	hApi			Handle to valid NurApi object instance. 
 * @param	passwd			Untraceable always executes in secured state; must be valid.
 ...
 */
NUR_API
int NURAPICONV NurApiUntraceableByEPC(HANDLE hApi, DWORD passwd, BYTE *epcBuffer, DWORD epcBufferLen, struct NUR_UNTRACEABLE_PARAM *pUtrace, DWORD szParam);

/** @fn int NURAPICONV NurApiUntraceable32(HANDLE hApi, DWORD passwd, BYTE sBank, DWORD sAddress, int sMaskBitLength, BYTE *sMask, struct NUR_UNTRACEABLE_PARAM *pUtrace, DWORD szParam)
 *
 * Performs the Gen2 version 2 "Untraceable" command with explicit selection criteria.
 *
 * @sa NurApiUntraceable, NurApiUntraceableByEPC, NUR_UNTRACEABLE_PARAM
 * @sa NUR_UTRACE_RANGE_NORMAL, NUR_UTRACE_RANGE_REDUCE
 * 	   
 * @param	hApi			Handle to valid NurApi object instance. 
 * @param	passwd			Untraceable always executes in secured state; must be valid.
 ...
 */
NUR_API
int NURAPICONV NurApiUntraceable32(HANDLE hApi, DWORD passwd, BYTE sBank, DWORD sAddress, 
								   int sMaskBitLength, BYTE *sMask, struct NUR_UNTRACEABLE_PARAM *pUtrace, DWORD szParam);

/** @fn int NURAPICONV NurApiAuthenticate32(HANDLE hApi, BOOL secured, DWORD passwd, BYTE sBank, DWORD sAddress, int sMaskBitLength, BYTE *sMask, struct NUR_AUTHENTICATE_PARAM *pAuth, DWORD szParam, struct NUR_AUTHENTICATE_RESP *pResp)
 *
 * Performs the Gen2 version 2 "Authenticate" command with explicit selection criteria.
 *
 * @sa NurApiAuthenticateByEPC, NurApiAuthenticate
 ...
 */
NUR_API
int NURAPICONV NurApiAuthenticate32(HANDLE hApi, BOOL secured, DWORD passwd, BYTE sBank, DWORD sAddress, 
										  int sMaskBitLength, BYTE *sMask, struct NUR_AUTHENTICATE_PARAM *pAuth, DWORD szParam, struct NUR_AUTHENTICATE_RESP *pResp);

/** @fn int NURAPICONV NurApiAuthenticateByEPC(HANDLE hApi, BOOL secured, DWORD passwd, BYTE *epcBuffer, DWORD epcBufferLen, struct NUR_AUTHENTICATE_PARAM *pAuth, DWORD szParam, struct NUR_AUTHENTICATE_RESP *pResp)
 *
 * Performs the Gen2 version 2 "Authenticate" command using the tag's EPC as selection parameter.
 *
 * @sa NurApiAuthenticate32, NurApiAuthenticate
 * @sa NUR_AUTHENTICATE_PARAM, NUR_AUTHENTICATE_RESP
 * 	   
 * @param	hApi			Handle to valid NurApi object instance. 
 * @param	secured			If TRUE then the operation is done in secured state (NOT RECOMMENDED).
 ...
 */
NUR_API
int NURAPICONV NURAPICONV NurApiAuthenticateByEPC(HANDLE hApi, BOOL secured, DWORD passwd, BYTE *epcBuffer, DWORD epcBufferLen, 
												  struct NUR_AUTHENTICATE_PARAM *pAuth, DWORD szParam, struct NUR_AUTHENTICATE_RESP *pResp);

/** @fn int NURAPICONV NurApiAuthenticate(HANDLE hApi, BOOL secured, DWORD passwd, struct NUR_AUTHENTICATE_PARAM *pAuth, DWORD szParam, struct NUR_AUTHENTICATE_RESP *pResp)
 *
 * Performs the Gen2 version 2 "Authenticate" command without explicitly selecting a tag.
 *
 * @sa NurApiAuthenticateByEPC, NurApiAuthenticate32
 * @sa NUR_AUTHENTICATE_PARAM, NUR_AUTHENTICATE_RESP
 * 	   
 * @param	hApi			Handle to valid NurApi object instance. 
 * @param	secured			If TRUE then the operation is done in secured state (NOT RECOMMENDED).
 ...
 */
NUR_API
int NURAPICONV NurApiAuthenticate(HANDLE hApi, BOOL secured, DWORD passwd, struct NUR_AUTHENTICATE_PARAM *pAuth, DWORD szParam, struct NUR_AUTHENTICATE_RESP *pResp);
...
/** @fn int NURAPICONV NurApiISO29167_10TAM32(HANDLE hApi, BYTE sBank, DWORD sAddress, int sMaskBitLength, BYTE *sMask, struct NUR_TAM_PARAM *pTAM, struct NUR_TAM_RESP *pTAMResp)
 *
 ...
 *
 * @sa NurApiISO29167_10TAM32, NurApiISO29167_10TAMByEPC, NurApiISO29167_10TAM, NUR_TAM_PARAM, NUR_TAM_RESP
 * 	   
 * @param	hApi			Handle to valid NurApi object instance. 
 * @param	sBank			Bank where the selection is applied to (EPC, TID or user memory).
 * @param	sAddress		Selection mask's bit address.
 ...
 */
NUR_API
int NURAPICONV NurApiISO29167_10TAM32(HANDLE hApi, BYTE sBank, DWORD sAddress, 
									  int sMaskBitLength, BYTE *sMask, struct NUR_TAM_PARAM *pTAM, struct NUR_TAM_RESP *pTAMResp);

/** @fn int NURAPICONV NurApiISO29167_10TAMByEPC(HANDLE hApi, BYTE *epcBuffer, DWORD epcBufferLen, struct NUR_TAM_PARAM *pTAM, struct NUR_TAM_RESP *pTAMResp)
 *
 * Performs the ISO29167-10 Tag Authentication Method (TAM) 1 or 2 specified by the parameters using EPC singulation.
 *
 * @sa NurApiISO29167_10TAM32, NurApiISO29167_10TAM, NUR_TAM_PARAM, NUR_TAM_RESP
 * 	   
 * @param	hApi			Handle to valid NurApi object instance. 
 * @param	epcBuffer		Pointer to the tag's expected EPC constents starting from bit addresss 32 (word addres 2) in the EPC bank.
 * @param	epcBufferLen	Length, in bytes, of the EPC buffer.
 ...
 */
NUR_API
int NURAPICONV NurApiISO29167_10TAMByEPC(HANDLE hApi, BYTE *epcBuffer, DWORD epcBufferLen, struct NUR_TAM_PARAM *pTAM, struct NUR_TAM_RESP *pTAMResp);

/** @fn int NURAPICONV NurApiISO29167_10TAM(HANDLE hApi, struct NUR_TAM_PARAM *pTAM, struct NUR_TAM_RESP *pTAMResp)
 *
 * Performs the ISO29167-10 Tag Authentication Method (TAM) 1 or 2 specified by the parameters using specific tag selection parameters.
 *
 * @sa NurApiISO29167_10TAM32, NurApiISO29167_10TAMByEPC, NUR_TAM_PARAM, NUR_TAM_RESP
 * 	   
 * @param	hApi			Handle to valid NurApi object instance. 
 * @param	pTAM			Pointer to the TAM parameter structure.
 * @param	pTAMResp		Pointer to the TAM response structure.
 ...
 */
NUR_API
int NURAPICONV NurApiISO29167_10TAM(HANDLE hApi, struct NUR_TAM_PARAM *pTAM, struct NUR_TAM_RESP *pTAMResp);
