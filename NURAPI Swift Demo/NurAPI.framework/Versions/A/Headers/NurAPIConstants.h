...
/** Gen 2 version 2: Untraceable's range reduction policy: normal. */
#define NUR_UTRACE_RANGE_NORMAL		0
/** Gen 2 version 2: Untraceable's range reduction policy: toggle (NOTE: not supported at the moment). */
#define NUR_UTRACE_RANGE_TOGGLE		1
/** Gen 2 version 2: Untraceable's range reduction policy: reduce. */
